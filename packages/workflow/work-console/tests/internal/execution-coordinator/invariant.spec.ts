...
import * as invariant from '../../../src/internal/execution-coordinator/invariant.ts'
...
describe('work-execution-coordinator invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@deepseek-ai/dsh-work-console/internal-execution-coordinator', expect.any(Function))
