...
This family owns global work-control state, durable execution efforts, DSH-native runner bridging, worker-node/environment resource facts, authenticated remote-node transport, and dynamic agent orchestration. Work-control, work-execution, work-node, and work-environment remain model-agnostic; runner/gateway consumers deliberately carry a bounded Task Context Package rather than replaying complete transcripts.
