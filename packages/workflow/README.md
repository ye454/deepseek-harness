...
This family owns global work-control state, durable execution efforts, DSH-native runner bridging, worker-node/environment resource facts, authenticated remote-node transport/runtime, evidence-backed validation, the global read-only Work Console projection, and dynamic agent orchestration. Work-control, work-execution, work-node, work-environment, work-validation, and work-console remain model-agnostic; runner/gateway consumers deliberately carry a bounded Task Context Package rather than replaying complete transcripts.
...
| [`work-console/`](work-console/README.md) | Derives passive Ideas, active execution facts, human-ready acceptance routing, Resource summaries, and on-demand Task Detail over Typert Remote | `ctx.workConsole` |
