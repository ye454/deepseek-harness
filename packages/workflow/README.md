...
| [`work-console/`](work-console/README.md) | Derives the project-independent global board, Resource/Pending summaries, and on-demand Task Detail over Typert Remote | `ctx.workConsole` |
