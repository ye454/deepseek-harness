...
- Next experiment: run the narrow pre-push checks, commit only intentional Work Console/Web bundle files and notes, push the current feature branch, and leave the local Web process available for manual inspection.
